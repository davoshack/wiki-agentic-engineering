...
> **Two senses of the term are now in circulation.** This page primarily develops the **practitioner-discipline sense** (Willison, Karpathy) — *how a human + a coding agent should work to produce good software*. A second, control-plane sense is in active use in the field (Kumar & Ramagopal, [[2026-05-26-agentic-engineering-swarms]]) — *how a fleet of role-differentiated agents should coordinate across a team or organization*. The two are not opposed; coding agents are components inside the control-plane systems Kumar & Ramagopal describe. The cross-cutting comparison lives in [[practitioner-discipline-vs-control-plane]]; the architecture itself lives in [[multi-agent-coordination]].
...
[[andy-dev-dan]] (a third practitioner voice, host of *agenticengineer.com* and seller of the *Tactical Agent Coding* course — read with the marketing caveat on his person page) sharpens the prescription from the *individual senior engineer*'s vantage: ***"Models matter less and less. What matters is the systems you place around your agents."*** His five-pillar frame — agent harness, software factory, extensible software, AFK / always-on agents (gated by tokeconomics), agentic access — is substrate-maximalist. Several of his terms anchor new topic pages: [[agent-harness-engineering]] (building your own harness as daily practice), [[software-factory]] (building the system that builds the system, with **ZTE / Zero Touch Engineering** as the aspirational endpoint), and [[tokeconomics]] (the 3-level funnel that gates always-on deployment on captured-revenue arbitrage rather than mere token-burn).
